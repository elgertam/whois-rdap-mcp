...
class RDAPService:
    ...
    async def lookup_domain(self, domain: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Domain RDAP lookup failed",
        ...
        try:
            ...
            for server in rdap_servers:
                try:
                    ...
                    logger.warning("RDAP server failed, trying next",
                                  ip=ip_address, server=server, error=str(e))
                    continue
            ...
            logger.error("IP RDAP lookup failed",
    ...
    async def _get_bootstrap_data(self, registry_type: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning("Failed to fetch bootstrap data",
                          registry_type=registry_type, error=str(e))
            return None
    
    def _find_servers_in_bootstrap(self, bootstrap_data: Dict[str, Any], 
                                 target: str) -> List[str]:
