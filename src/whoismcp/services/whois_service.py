...
class WhoisService:
    ...
    async def lookup_domain(self, domain: str) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                "Domain whois lookup completed successfully",
                domain=domain,
                server=whois_server,
            )
            ...
            logger.error("Domain whois lookup failed", domain=domain, error=str(e))
    ...
    async def lookup_ip(self, ip_address: str) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                "IP whois lookup completed successfully",
                ip=ip_address,
                server=whois_server,
            )
            ...
            logger.error("IP whois lookup failed", ip=ip_address, error=str(e))
